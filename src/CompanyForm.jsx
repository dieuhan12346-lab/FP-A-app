...
export default function CompanyForm({ initial, onSubmit, submitLabel, submittingLabel }) {
    ...
    <form onSubmit={submit}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
        <div style={fieldWrap}>
          ...
          <select style={inputStyle} value={accountingStandard} onChange={(e) => setAccountingStandard(e.target.value)}>
      ...
      <div style={fieldWrap}>
        ...
        <input style={inputStyle} type="text" value={taxRegime} onChange={(e) => setTaxRegime(e.target.value)} />
      </div>
